...
/**
 * Phase 0 placeholder home. Real thesis copy per seed §4.1 so the primitives
 * can be evaluated against the actual words they need to carry. Demo embed
 * (P1 Other Teacher) and full sections arrive in Phase 1+.
 */
export default function HomePage() {
  return (
    <main className="relative min-h-screen">
      ...
      {/* Primitive sanity check — confirms PullQuote renders with real copy. */}
      ...
      <footer className="border-t border-[color:var(--border)]">
        <div className="mx-auto w-full max-w-[var(--width-wide)] px-[var(--space-6)] py-[var(--space-12)] md:px-[var(--space-8)]">
          <p className="font-mono text-[var(--text-caption)] uppercase tracking-[var(--tracking-label)] text-[color:var(--text-faint)]">
            Phase 0 · Foundations shipped · Demos arrive in Phase 1
          </p>
        </div>
      </footer>
    </main>
